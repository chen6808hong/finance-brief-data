...
# 信息差·认知差：云端快照版提供跨领域通用型条目（财经/科技/科学/环境/国际），
# 不局限于财经金融；AI 精编版将覆盖为更有针对性的内容。
insights = [
    ...
    {"t": "量子计算已从实验室走向工程化，而非遥远科幻", "typ": "信息差", "cat": "科技",
     "d": "2026年我国量子科技迎来爆发式转化：九章四号、量筹一号、驭量·山海1000、本源悟空-180 相继亮相，行业融资规模快速放大，量子算力正从物理验证迈入工程交付。", "src": "新华社/科技日报"},
    {"t": "量子计算≠通用替代经典计算机", "typ": "认知差", "cat": "科技",
     "d": "把「量子优越性」演示等同于「量子计算机马上取代电脑」是典型认知差；它只在组合优化、AI储库计算、材料模拟等特定问题上提供指数级加速。", "src": "行业研究"},
    {"t": "「太空医院」已成为真实在轨验证方向", "typ": "信息差", "cat": "科学",
     "d": "轻舟试验飞船在轨验证了肌电检测、手持式血细胞分析、无创光疗等设备，国际空间站也完成首例在轨人体X光，长期驻留健康保障从概念走向装备。", "src": "中科院/光明日报"},
    {"t": "极端干旱致内河水位骤降，航运与农业连锁冲击被低估", "typ": "信息差", "cat": "环境",
     "d": "报道多聚焦高温，但更长期信号是内河水位显著降低；欧洲内河航运占货运比重高，水位下降直接冲击物流、农业灌溉与核电冷却。", "src": "央视新闻"},
    {"t": "地缘「框架达成」不等于风险解除，慢变量才是长期主线", "typ": "认知差", "cat": "国际",
     "d": "把阶段性框架当成终局是典型认知差；难民流动、气候压力、地缘博弈等慢变量对全球秩序的塑造，往往被单日头条掩盖。", "src": "央视新闻"},
]
